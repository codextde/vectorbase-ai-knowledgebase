    ...
    >
      {isPopular && (
        <div className="absolute -top-4 left-0 right-0 flex justify-center">
          <span className="z-10 rounded-full bg-gradient-to-r from-violet-500 to-purple-500 px-4 py-1 text-xs font-medium text-white">
            Most Popular
          </span>
        </div>
      )}
      ...
      >
        <div
          className={`h-12 w-12 rounded-xl flex items-center justify-center mb-4 ${planIconColors[plan.name]}`}
        >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden items-center gap-8 md:flex">
              ...
              <Link
                href="https://github.com/codextde/vectorbase-ai-knowledgebase"
                className="text-sm text-white/60 transition-colors hover:text-white"
              >
                Docs
              </Link>
        ...
        <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="text-center">
              ...
              >
                Upload documents, crawl websites, and create intelligent AI
                assistants. The modern RAG infrastructure for developers.
              </motion.p>
              ...
              >
                <Link href="/auth/signup">
                  <Button
                    size="lg"
                    className="h-12 gap-2 bg-white px-6 text-black hover:bg-white/90"
                  >
                    Start Building Free
                ...
                <Link href="https://github.com/codextde/vectorbase-ai-knowledgebase">
                  <Button
                    size="lg"
                    variant="ghost"
                    className="h-12 gap-2 border border-white/10 px-6 hover:bg-white/5"
                  >
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <AnimatedText className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-white/60">
                A complete RAG infrastructure with all the tools to upload,
                process, and query your knowledge bases at scale.
              </p>
            </AnimatedText>
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  description: "SOC 2 compliant, encrypted at rest",
                },
                {
                  icon: Bot,
                  title: "AI-Native",
                  description: "Built for LLM applications from day one",
                },
              ].map((item, i) => (
                <AnimatedText
                  key={item.title}
              ...
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-violet-500/10 via-purple-500/5 to-transparent p-8 sm:p-16">
                ...
                <div className="relative text-center">
                  ...
                  <p className="mx-auto mt-4 max-w-xl text-lg text-white/60">
                    Join thousands of developers building AI-powered
                    applications with VectorBase.
                  </p>
                  <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                    ...
                    <Link href="/contact">
                      <Button
                        size="lg"
                        variant="ghost"
                        className="h-12 gap-2 border border-white/10 px-8 hover:bg-white/5"
                      >
                        Contact Sales
                      </Button>
                    </Link>
      ...
      <footer className="border-t border-white/5 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
            <div className="lg:col-span-2">
              ...
              <p className="mt-4 max-w-xs text-sm text-white/60">
                The modern RAG infrastructure for building AI-powered knowledge
                bases.
              </p>
          ...
          <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 sm:flex-row">
            ...
            <p className="text-sm text-white/40">Made with ❤️ for developers</p>
          </div>
        </div>
      </footer>
    </div>
