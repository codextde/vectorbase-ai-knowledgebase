    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50/50 via-background to-background p-4">
      <div className="w-full max-w-md">
        <Link href="/" className="flex flex-col items-center mb-8 group">
          ...
          <span className="mt-3 text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent tracking-tight">
            VectorBase
          </span>
        </Link>
        ...
        <Card className="border-0 shadow-xl shadow-black/5">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription className="text-center">
              Get started with VectorBase for free
            </CardDescription>
          </CardHeader>
